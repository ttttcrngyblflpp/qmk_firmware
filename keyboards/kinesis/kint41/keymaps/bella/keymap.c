...
enum layer_names {_BELLA, _GAMING, _QWERTY, _DVORAK, _MAC, _PC, _KEYPAD, _PROGRAM};
enum my_keycodes {BELLA = SAFE_RANGE, GAMING, QWERTY, DVORAK, WIN, MAC, PC, STATUS, PROGRAM};
...
[_BELLA] = LAYOUT (
           ...
           KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,
                    KC_BSLS, KC_LALT, KC_LGUI, KC_LBRC,
           // Left Thumb
                    KC_DOWN,   KC_UP,
                              KC_GRV,
            KC_ENT,  KC_TAB,  KC_EQL,
           ...
           KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,
                    KC_RBRC, KC_RGUI, KC_RALT, KC_QUOT,
           // Right Thumb
           KC_LEFT, KC_RGHT,
           KC_MINS,
...
[_PROGRAM] = LAYOUT (
           ...
           _______, _______, _______, _______ , _______, _______,
           _______, _______, _______, _______ , _______, _______,
           _______,   BELLA, _______, _______ , _______,  GAMING,
           _______, _______, _______, _______ , _______, _______,
                    _______, _______, _______ , _______,
           // Left Thumb
                    _______, _______,
    ...
    if (record->event.pressed) {
        switch (keycode) {
            case QWERTY:
                ...
                return false;
            case BELLA:
                set_single_persistent_default_layer(_BELLA);
                layer_off(_MAC);
                layer_off(_PC);
                layer_on(_BELLA);
                layer_off(_GAMING);
            ...
            case DVORAK:
                ...
                return false;
            case MAC:
                if (!IS_LAYER_ON(_GAMING) && !IS_LAYER_ON(_BELLA)) {
                    layer_on(_MAC);
                    layer_off(_PC);
                }
                return false;
